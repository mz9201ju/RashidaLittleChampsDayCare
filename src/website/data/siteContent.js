...
export const PAGE_CONTENT = {
  ...
  gallery: {
    ...
    items: [
      ...
      { id: '11', alt: 'Children listening to a story with teacher.' },
      { id: '12', alt: 'Kids sharing a book during story time.' },
      { id: '13', alt: 'Children sitting in a circle for story time.' },
      { id: '14', alt: 'Teacher reading aloud to attentive children.' },
      { id: '15', alt: 'Children smiling and enjoying a story.' },
      { id: '16', alt: 'Kids cuddled up with blankets for story time.' },
      { id: '17', alt: 'Children pointing at pictures in a book.' },
      { id: '18', alt: 'Children quietly listening to a story.' },
      { id: '19', alt: 'Kids giggling during a funny story.' },
      { id: '20', alt: 'Children relaxing on mats for story time.' },
      { id: '21', alt: 'Teacher showing illustrations to children.' },
      { id: '22', alt: 'Children whispering and sharing story ideas.' },
      { id: '23', alt: 'Kids hugging stuffed animals during story time.' },
      { id: '24', alt: 'Children looking at a picture book together.' },
    ],
  },
  contact: {
    title: 'Contact',
